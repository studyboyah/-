<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\tp5\public/../application/admin\view\about\add_about.html";i:1513070587;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="add_about" id="add_about" method="post" action="<?php echo url("","",true,false);?>">
                        ...
                        <div class="hr-line-dashed"></div> 
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                             <textarea type="text"  name="secondname" id="secondname" class="form-control" style="resize:none"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div> 
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                            <textarea type="text"  name="threename" id="threename" class="form-control" style="resize:none"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div> 
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                             <textarea type="text"  name="fourname" id="fourname" class="form-control" style="resize:none"></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div> 
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                             <textarea type="text"  name="fivename" id="fivename" class="form-control" style="resize:none"></textarea>
                               <!--  <input id="fivename" type="text" class="form-control" name="fivename" > -->
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div> 
                            <div class="form-group">
