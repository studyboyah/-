<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"F:\tp5\public/../application/admin\view\article\index_cate.html";i:1513214058;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('add_cate'); ?>"><button class="btn btn-outline btn-primary" type="button">添加新闻分类</button></a> 
                    </div>
                </div>                                                                    
                </div>
            </div>
