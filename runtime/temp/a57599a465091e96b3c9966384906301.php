<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\tp5\public/../application/admin\view\talent\index_content.html";i:1513567976;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('add_content'); ?>"><button class="btn btn-outline btn-primary" type="button">添加内容</button></a> 
                    </div>
                </div>                                            
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('index_content'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
            ...
            <div class="example-wrap">
                <div class="example">
                    ...
                    <div style="text-align: right;">
                        共<?php echo $content; ?>条数据，<span id="allpage"></span>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">   
    ...
    function Ajaxpage(curr){
        var key=$('#key').val();
        $.getJSON('<?php echo url("index_content"); ?>', {
            page: curr || 1,key:key
