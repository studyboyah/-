<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"F:\tp5\public/../application/admin\view\contact\add.html";i:1513906635;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" name="add" id="add" method="post" action="<?php echo url("","",true,false);?>">
                        ...
                        <div class="hr-line-dashed"></div> 
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                              <input id="xname" type="text" class="form-control" name="xname" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div> 
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                              <input id="xphone" type="text" class="form-control" name="xphone" >
                            </div>
                        </div>
                         <div class="hr-line-dashed"></div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                              <input id="xaddress" type="text" class="form-control" name="xaddress" >
                            </div>
                        </div>
                         <div class="hr-line-dashed"></div>
                        <div class="form-group">
...
<script type="text/javascript">
    $(function(){
        ...
        function checkForm(){
            ...
            if( '' == $.trim($('#name').val())){
                layer.msg('小标题不能为空', {icon: 5,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
            if( '' == $.trim($('#ename').val())){
                layer.msg('英文名称不能为空', {icon: 5,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }
