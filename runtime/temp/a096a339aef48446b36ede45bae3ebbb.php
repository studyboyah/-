<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\tp5\public/../application/admin\view\talents\add_opus.html";i:1514011300;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    $(function(){
        ...
        function checkForm(){
            ...
            if( '' == $.trim($("#data_photo").val())){
                layer.msg('请输入封面', {icon: 5,time:1500,shade: 0.1}, function(index){
                    layer.close(index);
                });
                return false;
            }            
