<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"F:\tp5\public/../application/admin\view\product\add_list.html";i:1513927953;s:58:"F:\tp5\public/../application/admin\view\public\header.html";i:1492388819;s:58:"F:\tp5\public/../application/admin\view\public\footer.html";i:1492388819;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" name="add" id="add" method="post" action="add_list">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="xname" placeholder="请输入内容页标题">
                            </div>
                        </div>
                          <div class="hr-line-dashed"></div>
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                               <textarea type="text"  name="firstname" id="firstname" class="form-control" style="resize:none" ></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                         <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                               <textarea type="text"  name="leftmain" id="leftmain" class="form-control" style="resize:none" ></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                          <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                               <textarea type="text"  name="rightmain" id="rightmain" class="form-control" style="resize:none" ></textarea>
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                            <textarea type="text"  name="describe" id="describe" class="form-control" style="resize:none"></textarea>
                            </div>
                        </div> 
                        <div class="hr-line-dashed"></div>          
                        <div class="form-group">
